...
exports.fg = {
    black: !Caps.color ? "" : ansi.fg.standard[0],
    red: !Caps.color ? "" : ansi.fg.standard[1],
    green: !Caps.color ? "" : ansi.fg.standard[2],
    yellow: !Caps.color ? "" : ansi.fg.standard[3],
    blue: !Caps.color ? "" : ansi.fg.standard[4],
    magenta: !Caps.color ? "" : ansi.fg.standard[5],
    cyan: !Caps.color ? "" : ansi.fg.standard[6],
    white: !Caps.color ? "" : ansi.fg.standard[7]
};
exports.bg = {
    black: !Caps.color ? "" : ansi.bg.standard[0],
    red: !Caps.color ? "" : ansi.bg.standard[1],
    green: !Caps.color ? "" : ansi.bg.standard[2],
    yellow: !Caps.color ? "" : ansi.bg.standard[3],
    blue: !Caps.color ? "" : ansi.bg.standard[4],
    magenta: !Caps.color ? "" : ansi.bg.standard[5],
    cyan: !Caps.color ? "" : ansi.bg.standard[6],
    white: !Caps.color ? "" : ansi.bg.standard[7]
};

exports.palette = {
    name: exports.fgRgb([1, 2, 3], null, 0) + exports.italic,
